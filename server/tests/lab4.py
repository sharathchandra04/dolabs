...
def task1(creds, answers):
    ...
    def stask2():
        ...
        return presence
    def stask3():
        r = awsutils.check_security_ec2_link(creds, 'ec2l4-1', ['sgone'])
        if r == 'error':
            return False
        return r
    def stask4():
...
def task2(creds, answers):
    ...
    def stask3():
        ...
        security_group_ids = [sg['GroupId'] for sg in ec2l43ins.get('SecurityGroups', [])]
    ...
    def stask5():
        ...
        if ans4251 in volume_ids:return True
        return False
    def stask6():
        return True
    def task7():
